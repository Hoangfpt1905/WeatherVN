...
public class AdapterWeather extends BaseAdapter {
    ...
    Context context;
    List<com.hoangnd.weathervn.Weather> listDay;

    public AdapterWeather(Context context, List<com.hoangnd.weathervn.Weather> listDay) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.hoangnd.weathervn.Weather weather = listDay.get(position);
